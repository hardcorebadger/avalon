...
public partial struct WorkerAttributeSet : global::System.IEquatable<WorkerAttributeSet>
{
  /// <summary>
  /// Field attribute = 1.
  /// </summary>
  ...
  public WorkerAttributeSet DeepCopy()
  {
    ...
    _result.attribute = new global::Improbable.Collections.List<string>(attribute.Count);
    for (int _i = 0; _i < attribute.Count; ++_i)
    {
      _result.attribute.Add(attribute[_i]);
    }
    return _result;
