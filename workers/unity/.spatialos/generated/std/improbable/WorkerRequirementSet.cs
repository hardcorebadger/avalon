...
public partial struct WorkerRequirementSet : global::System.IEquatable<WorkerRequirementSet>
{
  /// <summary>
  ...
  public WorkerRequirementSet DeepCopy()
  {
    ...
    _result.attributeSet = new global::Improbable.Collections.List<global::Improbable.WorkerAttributeSet>(attributeSet.Count);
    for (int _i = 0; _i < attributeSet.Count; ++_i)
    {
      _result.attributeSet.Add(attributeSet[_i].DeepCopy());
    }
    return _result;
