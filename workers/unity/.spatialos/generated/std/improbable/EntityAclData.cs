...
public partial struct EntityAclData : global::System.IEquatable<EntityAclData>
{
  ...
  public EntityAclData DeepCopy()
  {
    ...
    _result.componentWriteAcl = new global::Improbable.Collections.Map<uint, global::Improbable.WorkerRequirementSet>(componentWriteAcl.Count);
    for (var _node = componentWriteAcl.First; _node != null; _node = _node.Next)
    {
      _result.componentWriteAcl.Add(_node.Value.Key, _node.Value.Value.DeepCopy());
    }
    return _result;
