...
[global::System.Obsolete("Please use Rotation.Writer (but see its documentation for semantic differences).")]
public interface RotationWriter : RotationReader
{
  Rotation.Updater Update { get; }
}
...
[global::Improbable.Entity.Component.ComponentId(1000)]
[global::System.Obsolete("Please use Rotation.Reader (but see its documentation for semantic differences).")]
public interface RotationReader
{
  ...
  // Field rotation = 1.
  float Rotation { get; }
  event global::System.Action<float> RotationUpdated;
}

public partial class Rotation : global::Improbable.Entity.Component.IComponentFactory
{
  [global::Improbable.Entity.Component.WriterInterface]
  [global::Improbable.Entity.Component.ComponentId(1000)]
  ...
  public interface Reader
  {
    ...
    /// </summary>
    global::Improbable.Core.RotationData Data { get; }
    ...
    /// </summary>
    global::Improbable.Entity.Component.PropertyCallbackHandler<float> RotationUpdated { get; set; }
  }
  ...
  /// </summary>
  [global::System.Obsolete("Please use Rotation.Writer.Send() instead (see the documentation for semantic differences).")]
  public interface Updater
  {
    void FinishAndSend();
    // Field rotation = 1.
    #pragma warning disable 0618
    Updater Rotation(float newValue);
  ...
  {
    dispatcher.OnAddComponent<Rotation>((op) => {
      ...
      else if (!loggedInvalidAddComponent)
      {
        global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
            "Component Rotation added to entity " + op.EntityId + ", but it already exists." +
            "This error will be reported once only for each component."));
        loggedInvalidAddComponent = true;
      }
    });

    dispatcher.OnRemoveComponent<Rotation>((op) => {
      Impl impl;
      ...
      {
        global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
            "Component Rotation removed from entity " + op.EntityId + ", but it does not exist." +
            "This error will be reported once only for each component."));
        loggedInvalidRemoveComponent = true;
      }
    });

    dispatcher.OnAuthorityChange<Rotation>((op) => {
      Impl impl;
      if (implMap.TryGetValue(op.EntityId, out impl))
      {
    ...
    dispatcher.OnComponentUpdate<Rotation>((op) => {
      Impl impl;
      if (implMap.TryGetValue(op.EntityId, out impl))
      {
  ...
  #pragma warning disable 0618
  public class Impl : RotationWriter, Writer, Updater
  #pragma warning restore 0618
  {
    ...
    public Impl(global::Improbable.Worker.Connection connection, global::Improbable.EntityId entityId, Data initialData)
    {
      ...
      rotationUpdateEventHandler = 
        new global::Improbable.Entity.Component.PropertyCallbackHandler<float>(() => data.Value.rotation);
    }
    ...
    public global::Improbable.Core.RotationData Data
    {
    ...
    private global::Improbable.Entity.Component.PropertyCallbackHandler<float> rotationUpdateEventHandler;

    public global::Improbable.Entity.Component.PropertyCallbackHandler<float> RotationUpdated
    {
      get { return rotationUpdateEventHandler; }  
	  set { rotationUpdateEventHandler = value; }  
    }
    ...
    private void TriggerCallbacks(Update update)
    {
      ...
      {
        rotationUpdateEventHandler.InvokeCallbacks(update.rotation.Value);
      }
    }
    ...
    private Rotation.Update currentUpdate = null;
    ...
    #pragma warning restore 0618
    {
      get
      {
        ...
        {
          currentUpdate = new Rotation.Update();
        }
        else
        {
          global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
              "Update for component Rotation called with an update already in-flight! " +
    ...
    #pragma warning disable 0618
    event global::System.Action<bool> RotationReader.AuthorityChanged
    #pragma warning restore 0618
    {
    ...
    private readonly global::Improbable.Entity.Component.DeprecatedEvent<global::System.Action<Update>, global::System.Action<float>> rotationWrapper =
        new global::Improbable.Entity.Component.DeprecatedEvent<global::System.Action<Update>, global::System.Action<float>>(RotationUpdated_Wrap);

    private static global::System.Action<Update> RotationUpdated_Wrap(global::System.Action<float> action)
    {
      return (update) => { if (update.rotation.HasValue) { action(update.rotation.Value); } };
    }

    #pragma warning disable 0618
    event global::System.Action<float> RotationReader.RotationUpdated
    #pragma warning restore 0618
    {
      add { ComponentUpdated.Add(rotationWrapper.Add(value, value.Target)); value(Data.rotation); }
      remove { ComponentUpdated.Remove(rotationWrapper.Remove(value, value.Target)); }
    }

    #pragma warning disable 0618
    Updater Updater.Rotation(float newValue)
    #pragma warning restore 0618
    {
