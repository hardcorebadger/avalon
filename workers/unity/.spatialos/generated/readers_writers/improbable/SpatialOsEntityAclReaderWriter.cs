...
public partial class EntityAcl : global::Improbable.Entity.Component.IComponentFactory
{
  ...
  #pragma warning restore 0618
  {
    ...
    private global::Improbable.Entity.Component.PropertyCallbackHandler<global::Improbable.WorkerRequirementSet> readAclUpdateEventHandler;

    public global::Improbable.Entity.Component.PropertyCallbackHandler<global::Improbable.WorkerRequirementSet> ReadAclUpdated
    {
      get { return readAclUpdateEventHandler; }  
	  set { readAclUpdateEventHandler = value; }  
    }
    private global::Improbable.Entity.Component.PropertyCallbackHandler<global::Improbable.Collections.Map<uint, global::Improbable.WorkerRequirementSet>> componentWriteAclUpdateEventHandler;
    ...
    {
      get { return componentWriteAclUpdateEventHandler; }  
	  set { componentWriteAclUpdateEventHandler = value; }  
    }
    ...
    private void TriggerCallbacks(Update update)
    {
      ...
      {
        readAclUpdateEventHandler.InvokeCallbacks(update.readAcl.Value);
      }
      if (update.componentWriteAcl.HasValue)
      {
        componentWriteAclUpdateEventHandler.InvokeCallbacks(update.componentWriteAcl.Value);
      }
    }
    ...
    private readonly global::Improbable.Entity.Component.DeprecatedEvent<global::System.Action<Update>, global::System.Action<global::Improbable.WorkerRequirementSet>> readAclWrapper =
        new global::Improbable.Entity.Component.DeprecatedEvent<global::System.Action<Update>, global::System.Action<global::Improbable.WorkerRequirementSet>>(ReadAclUpdated_Wrap);
    ...
    #pragma warning restore 0618
    {
      add { ComponentUpdated.Add(readAclWrapper.Add(value, value.Target)); value(Data.readAcl); }
      remove { ComponentUpdated.Remove(readAclWrapper.Remove(value, value.Target)); }
    }
    ...
    private readonly global::Improbable.Entity.Component.DeprecatedEvent<global::System.Action<Update>, global::System.Action<global::Improbable.Collections.Map<uint, global::Improbable.WorkerRequirementSet>>> componentWriteAclWrapper =
        new global::Improbable.Entity.Component.DeprecatedEvent<global::System.Action<Update>, global::System.Action<global::Improbable.Collections.Map<uint, global::Improbable.WorkerRequirementSet>>>(ComponentWriteAclUpdated_Wrap);
    ...
    #pragma warning restore 0618
    {
      add { ComponentUpdated.Add(componentWriteAclWrapper.Add(value, value.Target)); value(Data.componentWriteAcl); }
      remove { ComponentUpdated.Remove(componentWriteAclWrapper.Remove(value, value.Target)); }
    }
    ...
    {
      readAclWrapper.DisconnectTarget(actionTarget);
      componentWriteAclWrapper.DisconnectTarget(actionTarget);
    }
