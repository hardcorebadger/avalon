...
namespace Improbable.Unity.Core.EntityQueries
{
    ...
    {
        /// <summary>
        /// Creates an entity query which returns only entity IDs in the result set (component snapshots of entities will not be included).
        /// </summary>
        ...
        /// <summary>
        /// Creates an entity query which returns entities along with component snapshots, for each specified component type, in the result set.
        /// </summary>
        public static EntityQuery ReturnComponents(this IConstraint constraint, uint componentType, params uint[] componentTypes)
        {
            ...
            {
                if (ComponentDatabase.IdToMetaclass(type) == null)
                {
