...
namespace Improbable.Unity.Core.Acls
{
    ...
    public struct Acl
    {
        ...
        public Acl SetWriteAccess<TComponent>(WorkerRequirementSet requirementSet) where TComponent : IComponentMetaclass
        {
            ...
            var id = ComponentDatabase.MetaclassToId<TComponent>();
        ...
        {
            if (ComponentDatabase.IdToMetaclass(componentId) == null)
            {
        ...
        /// <summary>
        ///     Creates a new <see cref="Acl"/> starting with the given <see cref="EntityAclData"/>, and overwriting values in 'otherAcl' with those present in 'newAcl'.
        /// </summary>
        ...
        public static Acl GenerateServerAuthoritativeAcl(Worker.Entity entity)
        {
            ...
            foreach (var componentId in entity.GetComponents())
            {
