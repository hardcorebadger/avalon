...
namespace Improbable.Unity.Core
{
    ...
    public static class SpatialOS
    {
        ...
        private static UnityTraceListener unityTraceListener;
        ...
        /// <summary>
        ///     Start the boostrap process which results in connecting to SpatialOS.
        /// </summary>
        ...
        public static void Connect(GameObject gameObject)
        {
            ...
            if (Configuration.ShowDebugTraces)
            {
                unityTraceListener = new UnityTraceListener();
                System.Diagnostics.Debug.Listeners.Add(unityTraceListener);
            }

            if (TemplateProvider == null)
            {
                TemplateProvider = gameObject.GetComponent<DefaultTemplateProvider>() ?? gameObject.AddComponent<DefaultTemplateProvider>();
            }
        ...
        internal static void Dispose()
        {
            ...
            if (unityTraceListener != null)
            {
                System.Diagnostics.Debug.Listeners.Remove(unityTraceListener);
                unityTraceListener.Dispose();
                unityTraceListener = null;
            }
