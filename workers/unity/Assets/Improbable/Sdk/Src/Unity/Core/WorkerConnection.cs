...
namespace Improbable.Unity.Core
{
    ...
    public class WorkerConnection
    {
        ...
        /// <summary>
        ///     Returns a list of deployments associated with the current AppName.
        /// </summary>
        /// <returns>
        ...
        {
            return new Locator(parameters.ReceptionistIp, parameters.LocatorParameters);
        }
        ...
        {
            var connectionFuture = Worker.Connection.ConnectAsync(parameters.ReceptionistIp, parameters.ReceptionistPort, parameters.WorkerId, parameters.ConnectionParameters);
