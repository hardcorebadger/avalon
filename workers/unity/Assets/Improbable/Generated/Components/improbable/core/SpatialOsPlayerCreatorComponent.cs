...
{
    public class SpatialOsPlayerCreatorComponent: SpatialOsComponentBase
    {
        /// <inheritdoc />
        ...
        public override bool Init(ISpatialCommunicator communicator, EntityObject entityObject)
        {
            ...
            DispatcherCallbackKeys.Add(
                communicator.RegisterCommandRequest<global::Improbable.Core.PlayerCreator.Commands.CreatePlayer>(OnCreatePlayerCommandRequestDispatcherCallback));
        ...
        {
            OnAddComponentDispatcherCallback(new AddComponentOp<global::Improbable.Core.PlayerCreator> { EntityId = entityId, Data = new global::Improbable.Core.PlayerCreator.Data(((global::Improbable.Core.PlayerCreator.Impl)op.ComponentObject).Data) });
        }

        /// <inheritdoc />
        public override void OnComponentUpdatePipelineOp(UpdateComponentPipelineOp op)
        {
            OnComponentUpdateDispatcherCallback(new ComponentUpdateOp<global::Improbable.Core.PlayerCreator> { EntityId = entityId, Update = (global::Improbable.Core.PlayerCreator.Update)op.UpdateObject });
        }

        protected void OnAddComponentDispatcherCallback(AddComponentOp<global::Improbable.Core.PlayerCreator> op)
        {
        ...
        /// </summary>
        public virtual void SendComponentUpdate(global::Improbable.Core.PlayerCreator.Update update)
        {
            if (!hasAuthority)
            {
        ...
        /// </summary>
        public delegate void OnComponentUpdateCallback(global::Improbable.Core.PlayerCreator.Update update);
        ...
        protected void OnComponentUpdateDispatcherCallback(
            global::Improbable.Worker.ComponentUpdateOp<global::Improbable.Core.PlayerCreator> op)
        {
            if (op.EntityId != entityId)
            {
                return;
        ...
        protected void OnComponentUpdateDispatcherCallback(global::Improbable.Core.PlayerCreator.Update update) {
            if (onComponentUpdateCallbacks != null)
            {
        ...
        {
            private readonly
                global::Improbable.Worker.CommandRequestOp<global::Improbable.Core.PlayerCreator.Commands.CreatePlayer>
                commandRequestOp;
            ...
            {
                var commandResponse = new global::Improbable.Core.PlayerCreator.Commands.CreatePlayer.Response(response);
        ...
        protected void OnCreatePlayerCommandRequestDispatcherCallback(
            global::Improbable.Worker.CommandRequestOp<global::Improbable.Core.PlayerCreator.Commands.CreatePlayer> op)
        {
