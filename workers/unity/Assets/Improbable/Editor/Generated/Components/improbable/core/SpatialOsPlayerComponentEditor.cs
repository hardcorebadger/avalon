...
{
    [CustomEditor(typeof(SpatialOsPlayerComponent))]
    public class SpatialOsPlayerComponentEditor : UnityEditor.Editor
    {
        private SpatialOsPlayerComponent editedComponent;
        private SpatialOsPlayerComponentEditorData componentData;

        private class SpatialOsPlayerComponentEditorData : SpatialOsComponentEditorBase<SpatialOsPlayerComponent>
        {
            public int PlayerId
            {
        ...
        {
            editedComponent = (SpatialOsPlayerComponent) target;

            var hashCode = editedComponent.GetHashCode();
            componentData = (SpatialOsPlayerComponentEditorData) EditorObjectStateManager.GetComponentEditorData(hashCode);
            if(componentData == null)
            {
                componentData = new SpatialOsPlayerComponentEditorData();
