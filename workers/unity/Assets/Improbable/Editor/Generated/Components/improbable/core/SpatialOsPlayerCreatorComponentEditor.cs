...
{
    [CustomEditor(typeof(SpatialOsPlayerCreatorComponent))]
    public class SpatialOsPlayerCreatorComponentEditor : UnityEditor.Editor
    {
        private SpatialOsPlayerCreatorComponent editedComponent;
        private SpatialOsPlayerCreatorComponentEditorData componentData;

        private class SpatialOsPlayerCreatorComponentEditorData : SpatialOsComponentEditorBase<SpatialOsPlayerCreatorComponent>
        {        }

        protected virtual void OnEnable()
        {
            editedComponent = (SpatialOsPlayerCreatorComponent) target;

            var hashCode = editedComponent.GetHashCode();
            componentData = (SpatialOsPlayerCreatorComponentEditorData) EditorObjectStateManager.GetComponentEditorData(hashCode);
            if(componentData == null)
            {
                componentData = new SpatialOsPlayerCreatorComponentEditorData();
