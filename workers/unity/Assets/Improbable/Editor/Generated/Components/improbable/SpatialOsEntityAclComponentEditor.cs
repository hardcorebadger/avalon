...
{
    [CustomEditor(typeof(SpatialOsEntityAclComponent))]
    public class SpatialOsEntityAclComponentEditor : UnityEditor.Editor
    {
        private SpatialOsEntityAclComponent editedComponent;
        private SpatialOsEntityAclComponentEditorData componentData;

        private class SpatialOsEntityAclComponentEditorData : SpatialOsComponentEditorBase<SpatialOsEntityAclComponent>
        {        }

        protected virtual void OnEnable()
        {
            editedComponent = (SpatialOsEntityAclComponent) target;

            var hashCode = editedComponent.GetHashCode();
            componentData = (SpatialOsEntityAclComponentEditorData) EditorObjectStateManager.GetComponentEditorData(hashCode);
            if(componentData == null)
            {
                componentData = new SpatialOsEntityAclComponentEditorData();
